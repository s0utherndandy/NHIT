...
<head>
    ...
    <title>Excel 2013 - Programming with VBA - New Horizons Toronto Canada</title>
...
<img src="images/excelvba.jpg" width="100%" class="img-responsive"/><br/>
</div>
        <!-- Content Row -->
<div class="container topBar mainSection">
 ...
 <h4 class="h1-blue">Excel 2013 - Programming with VBA</h4>
 <hr class="hr-pink"/>
 
 <p>In this course, students will examine the Visual Basic for Applications Environment and created custom procedures to enhance the functionality of Excel.<br/><br/>
 ...
 <li>Using Expressions, Variables, and Intrinsic Functions</li>
 <li>Controlling Program Execution</li>
 <li>Working with Forms and Controls</li>
 <li>Working with the PivotTable Object</li>
...
<br/>
  ...
  <a href="#" class="list-group-item active">
    <h4 class="h1-orange list-group-item-heading "><span class="glyphicon glyphicon-circle-arrow-right"></span>&nbsp;&nbsp;MAY 9, 11, 13</h4>
    <p class="list-group-item-text">5:30pm - 9:30pm</p>
  </a>
</div>

  <div class="list-group">
  <a href="#" class="list-group-item active">
    <h4 class="h1-orange list-group-item-heading "><span class="glyphicon glyphicon-circle-arrow-right"></span>&nbsp;&nbsp;MAY 16, 18, 20</h4>
    <p class="list-group-item-text">5:30pm - 9:30pm</p>
  </a>
</div>

<div class="well col-lg-12 col-md-12"><h4 class="h1-blue"><span class="glyphicon glyphicon-shopping-cart"></span>&nbsp;&nbsp;$800.00 (+HST)</h4></div>


<p>NH Toronto Online Live Exclusive Opportunity (reg $885)</p>
