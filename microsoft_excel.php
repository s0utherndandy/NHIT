...
When employees know how to use Excel, this improves efficiency in the workplace. Employees who know how to create detailed worksheets, invoices, charts, and complex formulas achieve professional results in a fraction of the time.</p>
		...
		<div class="panel panel-default">
			<div class="panel-heading">
				<h5>What career opportunities are available to graduates from the Microsoft Excel Training program?</h5>
			</div>
			<div class="panel-body">
		
				<ul>
					<li>Business Intelligence Specialist or Data Analyst</li>
		...
		<div class="panel panel-default">
			<div class="panel-heading">
				<h4>Employees will be prepared for the following certifications</h4>
			</div>
			<div class="panel-body">
				<ul>
					<li>Microsoft Office Specialist (MOS)</li>
					<li>Microsoft Office Specialist (MOS) Expert</li>
					<li>Microsoft Office Specialist (MOS) Master</li>
				</ul>
		...
		<div class="panel panel-primary">
			<div class="panel-heading"><h4>Looking For More Information?</h4>
		</div>
		<div class="panel-body">
